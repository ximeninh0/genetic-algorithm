...
GeneticAlgorithm::GeneticAlgorithm(int tx_reprod, int tx_mut_indv, int tx_mut_gene){
    this->reproducion_tx = tx_reprod;
...
Individual GeneticAlgorithm::RunGeneticAlgorithim(Population &population, int epochs)
{
    ...
    Reproduction reproducion_tools(this->reproducion_tx, true);
